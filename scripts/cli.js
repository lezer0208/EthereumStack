...
const contractABI = require("../artifacts/contracts/Ethereumstack.sol/Ethereumstack.json").abi;

program
    .name("ethereumstack-cli")
    .description("CLI tool for Ethereumstack smart contract")
    .version("1.0.0");
