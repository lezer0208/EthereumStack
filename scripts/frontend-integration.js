 ...
 * This file demonstrates how to integrate Ethereumstack with a web frontend
 */

// For React/Vue/Angular applications
export class EthereumstackClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EthereumstackClient(provider, contractAddress);
